...
JNIEXPORT jintArray JNICALL Java_com_main_JNIOpencv_detectFace
  (JNIEnv *env, jobject o, jstring input_image, jstring cascade_face, jstring cascade_eye, jstring cascade_nose, jstring cascade_mouth)
{
		jintArray result;

		cout<<__FUNCTION__<<__LINE__<<endl;

	   input_image_path =env->GetStringUTFChars(input_image,0);
	    face_cascade_path = env->GetStringUTFChars(cascade_face,0);
	   eye_cascade_path = env->GetStringUTFChars(cascade_eye,0);
	    nose_cascade_path = env->GetStringUTFChars(cascade_nose,0);
	   mouth_cascade_path = env->GetStringUTFChars(cascade_mouth,0);

	   cout<<__FUNCTION__<<__LINE__<<endl;
	   cout<<"input_image_path:"<<input_image_path<<endl;
	   cout<<"face_cascade_path:"<<face_cascade_path<<endl;
	   cout<<"eye_cascade_path:"<<eye_cascade_path<<endl;
	   cout<<"nose_cascade_path:"<<nose_cascade_path<<endl;
	   cout<<"mouth_cascade_path:"<<mouth_cascade_path<<endl;
